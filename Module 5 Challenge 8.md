...
### Solve
i pressed tab after pwn to get the flag.

```bash
command 1 cat /challenge/pwncollege​ 
pwn.college{8vufDe_gZn3cL1kdKJxrkTS_tlF.0FN0EzNxwyN1AzNzEzW}
```

### New Learnings
learned how to do tab completion
