...
### Solve
I exported PWN and then set COLLEGE, after that I invoked /challenge/run

```bash
command 1: export PWN=COLLEGE
command 2: COLLEGE=PWN
command 3: /challenge/run
pwn.college{wfz3Hpt_Fp70SON2bNWwxLW18MY.QXyYTN0wyN1AzNzEzW}
```
