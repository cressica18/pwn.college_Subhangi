...
### Solve
used symmlink to get the flag
```bash
command 1: ln -s /flag /home/hacker/not-the-flag
command 2: /challenge/catflag
pwn.college{AJ7yYRCQ-SoN6fUbdiBqRGhAq26.QX5ETN1wyN1AzNzEzW}
```

### New Learnings
learned how to use symmlinks
