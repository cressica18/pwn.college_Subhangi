...
### Solve
I ran /challenge/hack and used tee with output process substitution so one copy went into /challenge/the and the other piped into /challenge/planet
...
### New Learnings
learned how to use process substituitions
